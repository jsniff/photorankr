...
<html>
	<head>
        <title>PhotoRankr - Social Photography Market</title>
...
<div>
		<div style="opacity:.8;z-index:1;left:0px:top:0px;position:relative;height:100px;width:100%;background-color:white;text-align:center;">
			<div class="container_24" style="float:center;font-family:helvetica neue; font-size:15px;">
				...
				<div>
				<div style="position:absolute;left:1000px;margin-top:20px;"><a class="btn btn-success" data-toggle="button" style="width:125px;margin-bottom:10px;" href="signup.php">Photographer Sign In</a></br> <a class="btn btn-success" data-toggle="button" style="width:125px;" href="market/signup.php">Buyer Sign In</a></div>
				</div>
...
<button type="submit"  onclick='this.form.action="market/signup2.php";' class="btn btn-success" data-toggle="button" style="float:left;width:160px;">Buyer Sign Up</button>
</div>
