		...
		<div class="grid_7 push_4" style="margin-top:10px;">
			<div class="grid_7 box"> <!--ID Tag-->
				<div style="height:130px;">
					...
					<img src="<?php echo $profilepic; ?>" height="95" width="95" />
				</div>
			...
			<div class="grid_7 box underbox"><!--About photo-->
				<h1> About </h1>
                    ...
                    if($exhibit && $expic1 && $expic2 && $expic3) {
                        ...
                        <a href="fullsize.php?image=',$expic1,'&view=',$view,'"><img style="float:left;padding:2px;" src="',$expic1,'" height="80" width="80" /></a> 
                        <a href="fullsize.php?image=',$expic2,'&view=',$view,'"><img style="float:left;padding:2px;" src="',$expic2,'" height="80" width="80" /></a> 
                        <a href="fullsize.php?image=',$expic3,'&view=',$view,'"><img style="float:left;padding:2px;" src="',$expic3,'" height="80" width="80" /></a>                         
                        </div>';
                    }
