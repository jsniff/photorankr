...
$returnURL = urlencode("http://www.photorankr.com/pr5/paypalcheckoutagain.php");
$cancelURL = urlencode("http://www.photorankr.com");
 
// Add request-specific fields to the request string.
$nvpStr = "&Amt=$paymentAmount&PaymentAmt=$paymentAmount&ReturnUrl=$returnURL&CANCELURL=$cancelURL&PAYMENTACTION=$paymentType&CURRENCYCODE=$currencyID";
