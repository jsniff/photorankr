...
$samename = "SELECT * FROM collections WHERE owner = '$owner'";
...
if($match > 0) 
    {
            header("location:profile.php?view=upload&cc=n&ns=name");
            exit();
    }
...
if (($numbertags < 1) | !$title ) 
		{
         		header("location:profile.php?view=upload&cc=n&ns=failure");
        		exit();
		}		
else {
//Build queries to create the new set
$setsquery = "INSERT INTO collections (owner, title, maintags, about, settag1, settag2, settag3, settag4) VALUES ('$owner','$title','$tags','$about','$settag1','$settag2','$settag3','$settag4')";
...
header("location: profile.php?view=collections&ncol=success");
exit();
