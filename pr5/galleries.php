...
<?php navbar(); ?>
    ...
    <div id="featuredPhotosDiv">
        ...
        <div class="statoverlay" style="z-index:1;background-color:white;position:relative;left:0px;top:-65px;width:280px;height:30px;-webkit-border-bottom-right-radius: 2px;-webkit-border-bottom-left-radius: 2px;-moz-border-radius-bottomright: 2px;-moz-border-radius-bottomleft: 2px;border-bottom-right-radius: 2px;border-bottom-left-radius: 2px;">
    ...
    <div id="featuredMarketPhotosDiv">
        ...
        <div class="statoverlay" style="z-index:1;background-color:white;position:relative;left:0px;top:-65px;width:280px;height:30px;-webkit-border-bottom-right-radius: 2px;-webkit-border-bottom-left-radius: 2px;-moz-border-radius-bottomright: 2px;-moz-border-radius-bottomleft: 2px;border-bottom-right-radius: 2px;border-bottom-left-radius: 2px;">
            <div style="line-spacing:1.48;padding:5px;color:#4A4A4A;">
                <div style="float:left;">
                    <span style="font-size:15px;font-weight:500;">$<?php echo $bigprice; ?></span>&nbsp;&nbsp;<span style="font-weight:500;font-size:15px;"><?php echo $bigcaption; ?></span>
                </div>
            </div>
        </div>
    </div>
     ...
     <div id="featuredPhotogsDiv">
        ...
        <div class="statoverlay" style="z-index:1;background-color:white;position:relative;left:0px;top:-65px;width:280px;height:30px;-webkit-border-bottom-right-radius: 2px;-webkit-border-bottom-left-radius: 2px;-moz-border-radius-bottomright: 2px;-moz-border-radius-bottomleft: 2px;border-bottom-right-radius: 2px;border-bottom-left-radius: 2px;">
            <div style="line-spacing:1.48;padding:5px;color:#4A4A4A;">
                <div style="float:left;">
                    <span style="font-size:15px;font-weight:500;"><?php echo $bigrep; ?></span>&nbsp;&nbsp;<span style="font-weight:500;font-size:15px;"><?php echo $bigname; ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="featuredExhibitsDiv">
        ...
        <div class="statoverlay" style="z-index:1;background-color:white;position:relative;left:0px;top:-65px;width:280px;height:30px;-webkit-border-bottom-right-radius: 2px;-webkit-border-bottom-left-radius: 2px;-moz-border-radius-bottomright: 2px;-moz-border-radius-bottomleft: 2px;border-bottom-right-radius: 2px;border-bottom-left-radius: 2px;">
            <div style="line-spacing:1.48;padding:5px;color:#4A4A4A;">
                <div style="float:left;">
                    <span style="font-size:15px;font-weight:500;"><?php echo $avgscore; ?></span>&nbsp;&nbsp;<span style="font-weight:500;font-size:15px;"><?php echo $settitle; ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="trendingPhotogsDiv">
        ...
        <div class="statoverlay" style="z-index:1;background-color:white;position:relative;left:0px;top:-65px;width:280px;height:30px;-webkit-border-bottom-right-radius: 2px;-webkit-border-bottom-left-radius: 2px;-moz-border-radius-bottomright: 2px;-moz-border-radius-bottomleft: 2px;border-bottom-right-radius: 2px;border-bottom-left-radius: 2px;">
            <div style="line-spacing:1.48;padding:5px;color:#4A4A4A;">
                <div style="float:left;">
                    <span style="font-size:15px;font-weight:500;"><?php echo $bigrep; ?></span>&nbsp;&nbsp;<span style="font-weight:500;font-size:15px;"><?php echo $bigtrendname; ?></span>
                </div>
            </div>
        </div>
    </div>
     ...
     <div id="trendingExhibitsDiv">
        ...
        <div class="statoverlay" style="z-index:1;background-color:white;position:relative;left:0px;top:-65px;width:280px;height:30px;-webkit-border-bottom-right-radius: 2px;-webkit-border-bottom-left-radius: 2px;-moz-border-radius-bottomright: 2px;-moz-border-radius-bottomleft: 2px;border-bottom-right-radius: 2px;border-bottom-left-radius: 2px;">
            <div style="line-spacing:1.48;padding:5px;color:#4A4A4A;">
                <div style="float:left;">
                    <span style="font-size:15px;font-weight:500;"><?php echo $trendavgscore; ?></span>&nbsp;&nbsp;<span style="font-weight:500;font-size:15px;"><?php echo $trendsettitle3; ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="freshPhotogsDiv">
        ...
        <div class="statoverlay" style="z-index:1;background-color:white;position:relative;left:0px;top:-65px;width:280px;height:30px;-webkit-border-bottom-right-radius: 2px;-webkit-border-bottom-left-radius: 2px;-moz-border-radius-bottomright: 2px;-moz-border-radius-bottomleft: 2px;border-bottom-right-radius: 2px;border-bottom-left-radius: 2px;">
            <div style="line-spacing:1.48;padding:5px;color:#4A4A4A;">
                <div style="float:left;">
                    <span style="font-size:15px;font-weight:500;"><span style="font-weight:500;font-size:15px;"><?php echo $bignewname; ?></span>
                </div>
            </div>
        </div>
    </div>
     ...
     <div id="freshExhibitsDiv">
        ...
        <div class="statoverlay" style="z-index:1;background-color:white;position:relative;left:0px;top:-65px;width:280px;height:30px;-webkit-border-bottom-right-radius: 2px;-webkit-border-bottom-left-radius: 2px;-moz-border-radius-bottomright: 2px;-moz-border-radius-bottomleft: 2px;border-bottom-right-radius: 2px;border-bottom-left-radius: 2px;">
            <div style="line-spacing:1.48;padding:5px;color:#4A4A4A;">
                <div style="float:left;">
                    <span style="font-size:15px;font-weight:500;"><?php echo $avgscore2; ?></span>&nbsp;&nbsp;<span style="font-weight:500;font-size:15px;"><?php echo $newsettitle; ?></span>
                </div>
            </div>
        </div>
    </div>
...
<!---Top Ranked Div---->
    <div class="galleryBlock" style="margin-top:65px;margin-left:68px;">
