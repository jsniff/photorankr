 ...
 //TOTAL CHARGES           
    if($incartresults > 0) {
        ...
        <div><a class="btn btn-success" style="margin-left:30px;" href="',$_SERVER['HTTP_REFERER'],'">Continue Shopping</a>
            ...
            echo'<div class="grid_18"><a name="added" style="color:black;text-decoration:none;"><div style="padding:15px;padding-right:200px;background-color:#ddd;width:180px;margin-left:25px;margin-top:50px;"><span style="font-size:22px;font-weight:200;">Payment Summary</span></div></a>
...
<input type="hidden" name="customeremail" value="',$customeremail,'">
    ...
    <div class="grid_18"><a name="added" style="color:black;text-decoration:none;" href="#"><div style="padding:15px;padding-right:200px;background-color:#ddd;width:180px;"><span style="font-size:22px;font-weight:200;">Billing Details</span></div>
    <br /><br /> 
