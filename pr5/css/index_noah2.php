...
<div class="CNav" style="margin-left:-5px;position:fixed;top:0;left:0;">
...
<div class="container_custom" style="clear:both;margin:60px auto 0 auto;width:1180px;padding-left:0px;">
	<!--WHERE WOOKMARK GOES-->
	<div id="picContainer">
		<div id="searchHome">
			<header> Search for something <br />  <span>awesome </span></header>
			<form>
				<input type="text" >
			</form>
		</div>
	...
	<!--FORM-->
	<div id="formContainer" style="position:inherit;margin:15px 0 0 0;">
		<hgroup>
			<header> 
		...
		<fieldset id="signUp">
			<form>
				...
				<div id="TNC" style="width:86%;height:60px;overflow-y:scroll;overflow-x:hidden;background:rgba(201,201,201,.9);padding:5px;
			margin-left:19px;margin-top:10px;border-radius:5px;	"> 
...
(f)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	Both parties agree that the foregoing Terms are the complete and exclusive statement of the mutual understanding of the parties and supersedes and cancels all previous written and oral agreements, communications, and other understandings relating to the subject matter of the Terms.
			...
			<input type="checkbox" value="1" style="float:left;width:20px;margin-top:26px;margin-left:30px;">
			</form>

		</fieldset>
		<button id="signUpBtn"> Create My Account </button>
		<div id="miniFooter" style="margin-top:610px;">
			<ul>
				<li> About </li>
				<li> Contact </li>
