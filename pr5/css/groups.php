...
<?php 
if(!$email) {
    echo'<div style="width:100%;height:35;padding:10px;margin-top:-10px;background-color:rgba(220,220,220,.6);font-weight:300;font-size:15px;text-align:center;position:fixed;"><a href="#">Login</a> to join this group.</div>';
}
?>
