...
$type = "reply";
$newsfeedsignupquery=mysql_query("INSERT INTO newsfeed (firstname, lastname, emailaddress, owner,type,thread) VALUES ('$firstname', '$lastname', '$sender', '$receiver','$type','$thread')");
...
To view the message, login and click here: http://photorankr.com/profile.php?view=messages&v=viewthread&thread=".$thread;
...
header("Location: profile.php?view=messages&v=viewthread&thread=$thread&action=messagesent#bottom");
