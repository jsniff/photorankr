<?php
    ...
    $query = mysql_query("SELECT * FROM photos WHERE time > '$lowertimebound' AND faves > 2 ORDER BY (points/votes) DESC LIMIT 3");
    ...
    $numphotogsquery = mysql_query("SELECT emailaddress FROM userinfo WHERE unsubscriber NOT IN (1) ORDER BY user_id ASC LIMIT 1");
                                    	...
                                    	<tr>
                                        	<td valign=\"top\">
                                            	<div mc:edit=\"std_preheader_content\">
                                                	The new PhotoRankr has arrived!
                                                </div>
                                            </td>
                                            <!-- *|IFNOT:ARCHIVE_PAGE|* 
                                                    ...
                                                    <tr>
                                                        <td valign=\"top\">
                                                            <div mc:edit=\"std_content00\">
                                                                ...
                                                                <span style=\"font-size:16px;\"><h4 class=\"h4\">PR Newsletter | Week 1 January</span></h4>
                                                                <br />
                                                                Dear PhotoRankr Members:
                                                                
                                                                <br /><br />

We've been working day and night to release the new PhotoRankr and without further delay it is here! In the new PhotoRankr you will find that most of the site has been overhauled. Most noticeably, you will see that we have added a groups feature, which will allow users to make groups around common photography interests. We encourage you to start making your own groups today. We have also overhauled the PhotoRankr marketplace. All photos are sellable on PhotoRankr, but only those photos without a watermark on them will be displayed in the PhotoRankr marketplace. 

<br /><br /> 

As a valued member of PhotoRankr, as always, we greatly appreciate your feedback. The following survey includes several important questions, which will significantly impact the future direction of PhotoRankr. Please give us your feedback at the following link: <a href=\"http://www.surveymonkey.com/s/HLRF8VJ\">PhotoRankr Improvement Survey</a>
                                    	...
                                    	<tr>
                                        	<td valign=\"top\" width=\"180\" class=\"leftColumnContent\">
                                                ...
                                                <table border=\"0\" cellpadding=\"20\" cellspacing=\"0\" width=\"100%\">
                                                    <tr mc:repeatable>
                                                        <td valign=\"top\">
                                                            <a href=\"http://photorankr.com/viewprofile.php?u=$topphotog1id\"><img src=\"http://photorankr.com/$topphotog1pic\" style=\"max-width:160px;\" mc:label=\"image\" mc:edit=\"tiwc200_image00\" /></a>
                                                            <div mc:edit=\"tiwc200_content00\">
                                                               ...
                                                               <a style=\"color:#333;\" href=\"http://photorankr.com/viewprofile.php?u=$topphotog1id\">Visit Portfolio</a>
                                        	...
                                        	<td valign=\"top\" width=\"180\" class=\"centerColumnContent\">
                                                ...
                                                <table border=\"0\" cellpadding=\"20\" cellspacing=\"0\" width=\"100%\">
                                                    <tr mc:repeatable>
                                                        <td valign=\"top\">
                                                            <a href=\"http://photorankr.com/viewprofile.php?u=$topphotog2id\"><img src=\"http://photorankr.com/$topphotog2pic\" style=\"max-width:160px;\" mc:label=\"image\" mc:edit=\"tiwc200_image00\" /></a>
                                                            <div mc:edit=\"tiwc200_content00\">
                                                               ...
                                                               <a style=\"color:#333;\" href=\"http://photorankr.com/viewprofile.php?u=$topphotog2id\">Visit Portfolio</a>
                                        	...
                                        	<td valign=\"top\" width=\"180\" class=\"rightColumnContent\">
                                                ...
                                                <table border=\"0\" cellpadding=\"20\" cellspacing=\"0\" width=\"100%\">
                                                    <tr mc:repeatable>
                                                        <td valign=\"top\">
                                                            <a href=\"http://photorankr.com/viewprofile.php?u=$topphotog3id\"><img src=\"http://photorankr.com/$topphotog3pic\" style=\"max-width:160px;\" mc:label=\"image\" mc:edit=\"tiwc200_image00\" /></a>
                                                            <div mc:edit=\"tiwc200_content00\">
                                                               ...
                                                               <a style=\"color:#333;\" href=\"http://photorankr.com/viewprofile.php?u=$topphotog3id\">Visit Portfolio</a>
