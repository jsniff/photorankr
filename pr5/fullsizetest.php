...
To view the photo, click here: http://photorankr.com/fullsize.php?image=".$image;
    ...
    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=fullsizetest.php?image=', $image, '&v=', $view, '">';
	exit();
...
<img style="margin-top:-4px;" src="graphics/blacklogo.png" width="125" />&nbsp;&nbsp;<span style="font-size:16px;">Please log in to follow ',$firstname,' ',$lastname,'</span>
  </div>
  <div modal-body" style="width:600px;">

<div id="content" style="font-size:16px;width:500px;height:150px;">
		
<img class="roundedall" style="border: 1px solid black;margin-left:10px;margin-top:30px;" src="',$profilepic,'" 
...
<div class="modal-header">
<a style="float:right" class="btn btn-primary" data-dismiss="modal">Close</a>
<img style="margin-top:-4px;" src="graphics/blacklogo.png" width="125" />&nbsp;&nbsp;<span style="font-size:16px;">Oops, you accidentally tried to follow yourself.</span>
  </div>
  <div modal-body" style="width:600px;">
...
<div class="modal-header">
<a style="float:right" class="btn btn-primary" data-dismiss="modal">Close</a>
<img style="margin-top:-4px;" src="graphics/blacklogo.png" width="125" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:16px;">You are already following ',$firstname,'.</span>
  </div>
  <div modal-body" style="width:450px;height:145px;">

<div id="content" style="font-size:16px;width:500px;height:150px;">
		
<img class="roundedall" style="border: 1px solid black;margin-left:10px;margin-top:20px;" src="',$profilepic,'" 
height="100px" width="100px" />

<div style="width:350px;margin-left:130px;margin-top:-80px;">
',$firstname,' ',$lastname,'<br />                 
...
<img style="margin-top:-4px;" src="graphics/blacklogo.png" width="125" />&nbsp;&nbsp;<span style="font-size:16px;">You are now following ',$firstname,' ',$lastname,'</span>
  </div>
  <div modal-body" style="width:600px;">

<div id="content" style="font-size:16px;width:500px;height:150px;">
		
<img class="roundedall" style="margin-top:30px;margin-left:10px;" src="',$profilepic,'" 
height="100px" width="100px" />
...
<div class="modal-header">
<a style="float:right" class="btn btn-primary" data-dismiss="modal">Close</a>
<img style="margin-top:-4px;" src="graphics/blacklogo.png"  width="125" />&nbsp;&nbsp;<span style="font-size:16px;">Please login to favorite this photo</span>
  </div>
  <div modal-body" style="width:600px;">
...
<div class="modal-header">
<a style="float:right" class="btn btn-primary" data-dismiss="modal">Close</a>
<img style="margin-top:5px;" src="graphics/blacklogo.png" width="125" />&nbsp;&nbsp;<span style="font-size:16px;margin-top:15px;">Oops, you tried to favorite your own photo.</span>
  </div>
  <div modal-body" style="width:500px;">
...
<div class="modal-header">
<a style="float:right" class="btn btn-primary" data-dismiss="modal">Close</a>
<img style="margin-top:5px;" src="graphics/blacklogo.png"  width="125" />&nbsp;&nbsp;<span style="font-size:16px;margin-top:15px;">This photo is already in your favorites.</span>
  </div>
  <div modal-body" style="width:500px;">

<div id="content" style="font-size:16px;width:500px;height:150px;">
		
<img style="border: 1px solid black;margin-left:10px;margin-top:25px;" src="',$image,'" 
height="100px" width="100px" />
...
<img style="margin-top:5px;" src="graphics/blacklogo.png" width="125" />&nbsp;&nbsp;<span style="font-size:16px;margin-top:15px;">This photo has been added to your favorites.</span>
  </div>
  <div modal-body" style="width:500px;">
...
<div class="grid_16 pull_1 comments-box">
    ...
    <?php
        ...
        if($_SESSION['loggedin'] == 1) {
            ...
            echo'
                <form action="" method="POST" />
                    ...
                    <input style="float:left;width:550px;height:20px;position:relative;top:10px;" type="text" name="comment" placeholder="Leave feedback for ',$firstname,'&#8230;" /></div>
                </form>';
        ...
        echo'
            ...
            <div style="float:left;padding-left:6px;width:560px;">
                <div style="float:left;color:#3e608c;font-size:14px;font-family:helvetica;font-weight:500;border-bottom: 1px solid #ccc;width:560px;"><div style="float:left;">',$commentername,' &nbsp;<span style="font-size:16px;font-weight:100;color:black;margin-top:2">|</span>&nbsp;<span style="color:#333;font-size:12px;">Rep: ',$commenterrep,'</span></div>&nbsp;&nbsp;&nbsp;
                 ...
                 if($email == $emailaddress) {
                    echo'
                        <div style="float:right;font-size:12px;font-weight:500;"><a style="color#ccc;text-decoration:none;" href="fullsizetest.php?image=',$image,'&action=deletecomment&cid=',$commentid,'">X</a></div>';
                }
                echo'
                </div>
    ...
    ?>
		...
		<div class="grid_7 push_3" style="margin-top:10px;">
    ...
    ?>
        ...
        ?>
                ...
                if($price != 'NFS') {
                echo'
				<button class="btn btn-primary" style="padding: .45em 1em .45em 1em;"><a href="fullsizemarket.php?imageid=',$imageID,'"><img src="graphics/cart_white.png" style="width:20px;height:20px;float:right;"/></a></button>';
                }
