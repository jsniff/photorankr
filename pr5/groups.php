        ...
        echo'<div class="grid_16">
         ...
         <!--End Content Box-->
            ...
            <div class="grid_6 groupsBar" style="width:235px;margin-left:20px;">
                ...
                //My Groups Div
                echo'<div id="myGroupsDiv">';
                    for($ii=0; $ii<$nummygroups; $ii++) {
                        ...
                        $group_id = substr($mygroups[$ii], 1, -1);
                             ...
                             <a style="color:#333;text-decoration:none;" href="groups.php?id=',$group_id,'">
                                ...
                                if($totalnumphotos > 2) {
                                    for($iii=0;$iii<$imagecount;$iii++) {
                                        ...
                                        echo'<img style="width:65px;padding:1px;padding-top:2px;" src="https://photorankr.com/',$source,'" />';
                                    }
                                }
       ...
       elseif($imagecount < 3) {
		...
		<div class="groupName"'; if($imagecount < 3) {echo'style="height:400px;"';} echo'>
			...
			<ul id="groupStats1">
				...
				<!--<li> <img src="graphics/camera.png"/> ',$totalnumphotos,' Photos </li>-->
			</ul>
			<ul  id="groupStats2">
            ...
            <div class="newsTriangle"></div>
                <div class="newsItem">
                    ...
                    <div class="postCommentBox">
                        ...
                        <textarea id="commentBox',$postid,'" style="resize:none;margin-left:5px;width:395px;height:20px;" placeholder="Leave feedback for ',$firstname,'&#8230;"></textarea>
