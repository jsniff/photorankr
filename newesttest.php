...
for($iii=1; $iii <= 16; $iii++) {
    ...
    $widthls = $width / 3.5;
        ...
        <div class="fPic" id="',$id,'" style="float:left;margin-right:20px;margin-top:20px;width:260px;height:260px;overflow:hidden;"><a href="http://photorankr.com/fullsize.php?image=',$image,'&v=n">
...
for($iii=1; $iii <= 16; $iii++) {
	...
	$userid = mysql_result($prsresult, $iii-1, "user_id");
		...
		echo '<div class="fPic" id="',$id,'" style="float:left;margin-right:20px;margin-top:20px;width:260px;height:260px;overflow:hidden;"><a href="viewprofile.php?u=',$userid,'">
