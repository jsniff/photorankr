...
<html>
  <head>       
  <title>"<?php echo $caption?>" <? echo " by ", $firstname, " ", $lastname, " On PhotoRankr"; ?></title>
  <meta name="description" content="View <?php echo $firstname, " ", $lastname; ?>'s photos on PhotoRankr, the number one site for photographers. Photos aren't cropped, but instead made to look good. You can buy and sell photos through PhotoRankr, as well." /> 
...
Portfolio Average: ',$portfolioranking,' <br /><br /><br />
			...
			echo'
<div class="modal-header">
<a style="float:right" class="btn btn-primary" href="fullsizeview.php?image=', $image,'&v=',$view,'&fw=1">Close</a>
...
By: ',$firstname,' ',$lastname,'<br /><br /><br />
        ...
        echo'
<div class="modal-header">
<a style="float:right" class="btn btn-primary" href="fullsizeview.php?image=', $image,'&v=',$view,'&f=1">Close</a>
...
<body oncontextmenu="return false;"  class="background" style="overflow-x: hidden;min-width:1240px;">
...
"><?php echo '(',$firstname,'\'s Portfolio) <span style="font-size:23px;">"',$caption,'"</span>'; ?>
</div></div></div>
