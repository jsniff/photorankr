...
{% for (var i=0, file; file=o.files[i]; i++) { %}
	...
	<td colspan="1" class="desc">Name: <input type="text" name="desc"></td>
        ...
        <div>
<td colspan="1" class="desc">Price: <input type="text" name='{%= "price_" + String(file.name).replace(/([.]+)/gi, '_')%}'/></td>
        </div>
	</div>
<td colspan="1" class="desc">Keyword: <input type="text" name='{%= "keyword_" + String(file.name).replace(/([.]+)/gi, '_')%}'/></td>
<td>
    <input name="singlestyletags[][standardcontentlicense]"type="checkbox">Standard Content License
    <input name="singlestyletags[][extendedlicense1]"type="checkbox">Unlimited Reproduction and Print Run
     <input name="singlestyletags[][extendedlicense2]"type="checkbox">Multi-Seat License
    <input name="singlestyletags[][limitedlicense]"type="checkbox">Limited Resale
     <input name="singlestyletags[][extendedlicense4]" type="checkbox">Electronic Resale or Other Distribution
</td>
