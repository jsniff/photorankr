...
if(isset($_GET['u'])){
		$user_id = mysql_real_escape_string($_GET['u']);
	}
    
$userquery = mysql_query("SELECT emailaddress FROM userinfo WHERE user_id = '$user_id'");
$arry = mysql_fetch_array($userquery);
$emailaddress = $array['user_id'];
...
<div class="photoshadow fPic" id="',$ratio,'" style="width:245px;height:245px;overflow:hidden;float:left;margin-left:10px;margin-top:30px;"><a href="http://www.photorankr.com/fullsizeview.php?image=', $image[$iii], '">
