...
<body oncontextmenu="return false;"  class="background" style="overflow-x: hidden;min-width:1100px;">
 ...
 <!--NAVIGATION BAR-->
<div class="navbar" style="z-index:10;padding-top:0px;min-width:1100px;font-size:16px;width:100%;">
...
$ctype = 'campaign';
$campaignnews = "SELECT * FROM newsfeed WHERE type = '$ctype'";
...
"></b></a>
						<ul class="dropdown-menu" data-dropdown="dropdown">
							...
							<li><a style="color:#fff;" href="fullsizeview.php?image=', $image, '&action=logout">Log Out</a></li>
						</ul>'; 
} else {
				echo '	
                <li class="dropdown">
