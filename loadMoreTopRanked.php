...
if($_GET['lastPicture']) {
	$query = "SELECT * FROM photos WHERE points < ".$_GET['lastPicture']." ORDER BY points DESC LIMIT 0, 8";
...
for($iii=1; $iii <= 8; $iii++) {
    ...
    $widthls = $width / 2.5;
     	...
     	echo '<div class="fPic" id="',$points,'" style="float:left;margin-right:20px;margin-top:20px;width:280px;height:280px;overflow:hidden;"><a href="http://photorankr.com/fullsize.php?image=',$image,'&v=r">
