...
if($filter == '') {
        ...
        $querycount = mysql_query("SELECT * FROM photos,userinfo WHERE concat(caption,location,tag1,tag2,tag3,tag4) LIKE '%$searchterm%' OR firstname LIKE '%".$searchterm[0]."%' AND lastname  LIKE '%".$searchterm[1]."%' OR lastname LIKE '%".$searchterm[0]."%'");
        $numresultscount = mysql_num_rows($querycount);
        echo $numresultscount .'test';
