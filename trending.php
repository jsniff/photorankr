	...
	echo '			
                ...
                <a style="color:#fff;margin-top:2px;" href="signin.php" class="dropdown-toggle" data-toggle="dropdown">Log In<b class="caret"></b></a>
						<ul class="dropdown-menu" data-dropdown="dropdown">
							...
							<li><br/></li>
							<form name="login_form" method="post" action="trending.php?action=login">
...
<a style="background-color:#1a618a;color:white;" class="accordion-toggle" href="trending.php">Photography </a>
</div>
...
<div class="accordion-group">
<div class="accordion-heading">
<a style="background-color:#1a618a;color:white;" class="accordion-toggle" href="trending.php?view=prs">Photographers</a>
</div>
...
for($iii=1; $iii <= 16; $iii++) {
    ...
    $widthls = $width / 3.5;
		...
		echo '<div class="phototitle fPic" id="',$id,'" style="width:240px;height:240px;overflow:hidden;"><a href="http://photorankr.com/fullsize.php?image=',$image,'&v=t">
        
          <div class="statoverlay" style="z-index:1;left:0px;top:170px;position:relative;background-color:black;width:240px;height:75px;"><p style="line-spacing:1.48;padding:5px;color:white; text-decoration:none;">"',$caption,'"<br>By: ',$fullname,'</br>Score: ',$score,'</p></div>
...
elseif($view == 'prs') {
 ...
 echo'<div id="container" style="width:1140px;position:relative;left:-115px;top:50px;">';
for($iii=1; $iii <= 30; $iii++) {
    $owner = mysql_result($result, $iii-1, "emailaddress");
    $ownerquery = mysql_query("SELECT * FROM userinfo WHERE emailaddress = '$owner'");
    $profilepic = mysql_result($ownerquery, 0, "profilepic");
    $user_id = mysql_result($ownerquery, 0, "user_id");
    ...
    echo '
       <div class="phototitle" style="width:240px;height:300px;overflow:hidden;background-color:white;">
			<a href="viewprofile.php?u=',$user_id,'"><img onmousedown="return false" oncontextmenu="return false;" src="',$profilepic,'" height="240px" width="240px" /></a><div style="margin-top:0px;font-size:15px;text-align:center;">',$fullname,'</div></div>'; 
