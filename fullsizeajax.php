 ...
 //DISCOVER SCRIPT
  ...
  $discoverimage = mysql_result($viewresult, 0, "id");
    ...
    if(htmlentities($_GET['uf']) == 1) {
        ...
        $newfollowing = str_replace($formattedemail,"",$following);
...
Avg. Portfolio: ',$portfolioranking,' <br /><br /><br />
			...
			echo'
<div class="modal-header" style="background-color:#111;color:#fff;">
<a style="float:right" class="btn btn-success" onclick="ajaxFollow()" data-dismiss="modal">Close</a>
...
<div class="grid_16 pull_1 comments-box">
    ...
    var commenter = "<?php echo $email; ?>";
	var queryString = "?comment=" + comment + "&commenter=" + commenter;
	ajaxRequest.open("GET", "commentajax.php" + queryString, true);
	ajaxRequest.send(null); 
    ...
    <?php
        ...
        if($_SESSION['loggedin'] == 1) {
            ...
            echo'
                    ...
                    <input style="float:left;width:495px;position:relative;top:10px;" type="text" id="comment" placeholder="Leave feedback for ',$firstname,'&#8230;" onsubmit="ajaxComment()" />
                    </div>';         
        }
...
<!--PHOTOGRAPHER ID-->
		...
		<div class="grid_7 push_4" style="margin-top:10px;">
            ...
            <?php
                ...
                if ($match > 0) {
                echo'
                <a href="fullsizeajax.php?imageid=',$imageid,'&view=',$view,'&uf=1"><button style="width:80px;margin-left:15px;" class="btn unfollow"> Unfollow </button></a>';
        ...
        echo'
            ...
            echo '<div style="position: relative; top: 7px; margin-left:-5px; font-size: 12px; font-weight:200; font-family:"helvetica neue",helvetica; padding-right:6px;">Thanks for voting</div>';
            ...
            if(!$ranking) {
                ...
                echo '">
                <form>
                <select id="ranking" style="width:80px; height:30px;margin-left:15px;margin-top:2px;" onclick="ajaxRank()">
