...
To view the photo, click here: http://photorankr.com/fullsizeview.php?image=".$imagelink;
          $headers = 'From:PhotoRankr <photorankr@photorankr.com>';
                    if($foundsetting > 0) {
...
$foundsetting = strpos($setting_string,$find);
        ...
        $message = stripslashes($message) . "To view the photo, click here: http://photorankr.com/fullsizeview.php?image=".$imagelink;
        $headers = 'From:PhotoRankr <photorankr@photorankr.com>';
                  if($foundsetting > 0) {
...
?>
		...
		<div class="grid_7 push_2" style="margin-top:10px;">
            ...
            elseif(votematch && ($voteremail != $emailaddress)){
                echo '<div style="position: relative; top: 7px; left:-3px; text-align: center; font-size: 15px; font-family: arial;">You already voted!</div>';

            }
    
            elseif($voteremail == $emailaddress) {
                echo '<div style="position: relative;  top: 7px; text-align: center; font-size: 15px; font-family: arial;">Oops, your photo!</div>';

            }
            }
    
        else{
                echo '<div style="position: relative; top: 7px; text-align: center; font-size: 15px; font-family: arial;">Please login to vote</div>';
    ...
    ?>
        ...
        ?>
			...
			<div class="grid_7 box underbox"><!--Next photos-->
				...
				<div class="nextimg">	
					<a href="fullsizeview.php?image=<?php echo $imageOne; ?>&v=<?php echo $view; ?>"><img src="<?php echo $imageThreeThumb; ?>"id="nextimg3"/></a>
				</div>
