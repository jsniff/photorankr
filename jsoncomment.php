<?php
    ...
    if($voteremail) {
        ...
        $rankcheck = mysql_query("SELECT voters,points,votes FROM photos WHERE source = '$image'") or die(mysql_error());
        ...
        $votematch=strpos($votecheck, $voteremail);
    ...
    $arr = array('header' => ’How to Handle the Ajax Response’, 'description' => ’An in-depth explanation of how to handle the Ajax response.’, 'sourceURL' => ’http://www.krishadlock.com/clients/informit/AjaxResponse/AjaxResponse.zip’);
