...
if ($_GET['action'] == "login") { // if login form has been submitted
    ...
    header("location:http://photorankr.com/fullsize.php?image=$image&v=$view");
...
//Grab VIEWERS reputation score
    ...
    $numtoprankedphotos2 = mysql_num_rows($toprankedphotosquery2);
...
<html>
  ...
  <meta name="description" content="View photos on PhotoRankr, the number one site for photographers. Photos aren't cropped, but instead made to look good. You can buy and sell photos through PhotoRankr, as well." />
...
<body oncontextmenu="return false;" class="background" style="overflow-x: hidden;min-width:1100px;">
...
<div class="phototitle" style="height:<?php echo $newheight; ?>px;width:<?php echo $newwidth; ?>px;margin-top:-135px;min-height:250px;">
 <img onmousedown="return false" oncontextmenu="return false;" alt="<?php echo $tags; ?>" style="min-height:250px;"src="<?php echo $image; ?>" height="<?php echo $newheight; ?>px" width="<?php echo $newwidth; ?>px" /></div>
...
<span style="margin-left:30px;"><a style="text-decoration:none;" href="fullsize.php?image=<?php echo $imageBefore; ?>&v=<?php echo $view; ?>"><img src="graphics/arrow left.png" alt="Scroll through photos in their full size glory"
height="50" width="50"/></a></span>

<span style="margin-left:55px;"><a style="text-decoration:none;" href="fullsize.php?image=<?php echo $imageOne; ?>&v=<?php echo $view; ?>"><img  src="graphics/arrow right.png" alt="Scroll through photos in their full size glory"
height="50" width="50"/></a></span>
...
?>
 ...
 if(!$ranking) {
    ...
    <a href="#"><button class="btn btn-success" style="width:75px; height: 28px; margin-top:-6px; margin-left:15px;font-family: arial; font-size:14px;">RANK:</button></a>&nbsp;
	<select name="ranking" style="width:60px; height:30px;margin-left:15px;margin-top:2px;" onchange="submitMyForm(this)">
...
echo'
<br />
<a class="btn btn-danger" data-toggle="modal" data-backdrop="static" href="#fvmodal" style="width:145px; height: 20px; margin-left:30px; font-family: arial; margin-top:-33px; font-size:14px; opacity: .8;">FAVORITE</a><br/>';
?> 
...
echo '<span style="position: relative; top: 0px; left: 0px;"><a href="fullsize.php?image=',$imageOne,'&v=',$view,'"><img class="previews" alt="Preview some of the best photos on the web." src= "http://photorankr.com/', $imageOneThumb, '" height="150" width="190"/></a></span>

<span style="position: relative; top: 0px; left: 0px;"><a href="fullsize.php?image=',$imageTwo,'&v=',$view,'"><img class="previews" alt="These previews allow you to see what is coming up next" src= "http://photorankr.com/', $imageTwoThumb, '" height="150" width="190"/></a></span>

<span style="position: relative; top: 0px; left: 0px;"><a href="fullsize.php?image=',$imageThree,'&v=',$view,'"><img class="previews" alt="Scroll through photos to find photos to buy" src= "http://photorankr.com/', $imageThreeThumb,'" height="150" width="190"/></a></span>';
...
<?php
        ...
        if ($iso) {
        echo'
        <span style="opacity: .8">ISO: </span>',$iso,'<br />';
        }
        
        if ($software) {
        echo'
        <span style="opacity: .8">Software: </span>',$software,'<br />';
        }
