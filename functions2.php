...
<?php
    ...
    if($_SESSION['loggedin'] == 1) { 
        echo'<li'; if(strpos($uri,'newsfeed.php')) {echo' id="inset"';} echo'><a href="newsfeed.php"><img src="graphics/news_b.png"/><p> News </p></a></li>';
    }
    
    echo'
        <li id="shadowleft" class="dropdown"'; if(strpos($uri,'galleries.php') || strpos($uri,'newest.php') || strpos($uri,'trending.php') || strpos($uri,'topranked.php') || strpos($uri,'discover.php') || strpos($uri,'fullsize.php') || strpos($uri,'fullsizeview.php')) {echo' id="inset"';} echo'><a data-toggle="dropdown" class="dropdown-toggle" href="newest.php"><img src="graphics/galleries_b.png"/><p> Galleries </p></a>
        
            <ul class="dropdown-menu" style="height:67px;width:310px;margin-top:-75px;margin-left:73px;background-color:#555;    background-color:rgba(214, 214, 214, 01);box-shadow: 2px 0px 3px #222;border:none;-webkit-border-top-right-radius: 2px;-webkit-border-bottom-right-radius: 2px;-moz-border-radius-topright: 2px;-moz-border-radius-bottomright: 2px;border-top-right-radius: 2px;border-bottom-right-radius: 2px;-webkit-border-top-left-radius: 1px;-webkit-border-bottom-left-radius: 1px;-moz-border-radius-topleft: 1px;-moz-border-radius-bottomleft: 1px;border-top-left-radius: 1px;border-bottom-left-radius: 1px;">

                <a style="text-decoration:none;color:#fff;display:inline;" href="newest.php"><li class="horizontalDrop" style="display:inline;width:145px;margin-top:-5px;"> <img style="padding:3px;width:23px;height:23px;" src="graphics/clock.png" /> <br /> Newest </li></a>
                <a style="text-decoration:none;color:#fff;display:inline;" href="trending.php"><li class="horizontalDrop" style="display:inline;width:145px;margin-top:-5px;"><img style="padding:3px;width:23px;height:23px;" src="graphics/graph.png" /> <br /> Trending </li></a>
                 <a style="text-decoration:none;color:#fff;display:inline;" href="topranked.php"> <li class="horizontalDrop" style="display:inline;width:145px;margin-top:-5px;"><img style="padding:3px;width:23px;height:23px;" src="graphics/award.png" /> <br /> Top Ranked </li></a>
                 <a style="text-decoration:none;color:#fff;display:inline;" href="topranked.php"> <li class="horizontalDrop" style="display:inline;width:145px;margin-top:-5px;"><img style="padding:3px;width:23px;height:23px;" src="graphics/star.png" /> <br /> Featured </li></a>
            </ul>
        </li>
        
		<li id="shadowleft" '; if(strpos($uri,'groups.php')) {echo' id="inset"';} echo'><a href="groups.php"><img src="graphics/groups_b.png"/><p> Groups </p></a></li>
        
		<li id="shadowleft"'; if(strpos($uri,'market.php') || strpos($uri,'cart.php')) {echo' id="inset"';} echo'><a href="market.php"><img src="graphics/market_b.png"/><p> Market </p></a></li>
        
		<li id="shadowleft"'; if(strpos($uri,'blog.php')) {echo' id="inset"';} echo'><a href="blog.php"><img src="graphics/blog_b.png"/><p> Blog </p></a></li>
	</ul>
</div>
	...
	<ul>';
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu" style="height:120px;margin-top:0px;background-color:#555;">
                <a style="text-decoration:none;color:#fff;" href="newest.php"><li id="shadow" class="CNavDrop" style="width:145px;margin-top:-5px;"> Newest </li></a>
                <a style="text-decoration:none;color:#fff;" href="trending.php"><li id="shadow" class="CNavDrop" style="width:145px;"> Trending </li></a>
                 <a style="text-decoration:none;color:#fff;" href="topranked.php"> <li id="shadow" class="CNavDrop" style="width:145px;"> Top Ranked </li></a>
            </ul>
        </li>
        
        <li id="shadow" '; if(strpos($uri,'discover.php') || $view == 'n') {echo' id="topselected"';} echo'><a style="text-decoration:none;color:#fff;" href="discover.php"> Discover </a></li>';
        }
        ...
        if($_SESSION['loggedin'] == 1) { 
            if(strpos($_SERVER['REQUEST_URI'],'profile.php') !== false) {
                echo'<a href="newest.php?action=logout"><li>  Log Out </li></a>';
            }
        ...
        //Log Out Button
        elseif($_SESSION['loggedin'] != 1 && !strpos($uri,'signup.php') && !strpos($uri,'register.php')) { 
            echo'<li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="font-family:helvetica;text-decoration:none;color:#fff;"> Log In </b></a>
                        ...
                        echo'
                            ...
                            <div style="float:left;text-align:center;padding-botom:5px;"><input type="submit" class="btn btn-success" value="Log In" style="font-size:18px!important;width:160px!important;margin-top:10px;margin-left:15px;padding-left:35px;!important" id="loginButton"/></div>
                        </form>
                        </div>
                    </ul>
                </li>';
        ...
        if($_SESSION['loggedin'] == 1) { 
            ...
            <!-- creation menu -->
                ...
                <a style="text-decoration:none;color:#fff;" href="profile.php?view=upload&option=newcollection"> <li id="shadow" class="CNavDrop" style="width:145px;"><i style="float:left;margin-top:2px;padding-right:4px;" class=" icon-folder-open icon-white"></i> New Collection </li></a>
        ...
        if($_SESSION['loggedin'] == 1) {
            ...
            echo'<li class="dropdown" style="width:140px;height:19px;float:right;margin-top:-5px;">        
                <img id="hideshow" style="height:30px;width:30px;" src="https://photorankr.com/',$sessionprofilepic,'" />
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="text-decoration:none;color:#fff;" href="profile.php"><span id="notifNum" style="color:#fff;text-align:center;font-size:13px;font-weight:500;padding-bottom:5px;">',$sessionfull,'</span></a>
                    
                    <ul class="dropdown-menu" style="height:205px;margin-top:0px;margin-right:10px;background-color:#555;">
                <a style="text-decoration:none;color:#fff;" href="profile.php"><li id="shadow" class="CNavDrop" style="width:145px;margin-top:-5px;"> Portfolio </li></a>
                <a style="text-decoration:none;color:#fff;" href="profile.php?view=faves"><li id="shadow" class="CNavDrop" style="width:145px;"> Favorites </li></a>
                 <a style="text-decoration:none;color:#fff;" href="profile.php?view=store"> <li id="shadow" class="CNavDrop" style="width:145px;"> Store </li></a>
                 <a style="text-decoration:none;color:#fff;" href="profile.php?view=messages"> <li id="shadow" class="CNavDrop" style="width:145px;"> Messages </li></a>
                 <a style="text-decoration:none;color:#fff;" href="profile.php?view=settings"> <li id="shadow" class="CNavDrop" style="width:145px;"> Settings </li></a>
            </ul>
        </li>';
        
        }
        
        if(!strpos($uri,'signup.php') && !strpos($uri,'register.php')) {
            echo'
            <li style="width:120px;height:19px;color:#333;float:right;margin-right:135px;">
            <img style="float:right;margin-right:-150px;" id="search" src="graphics/glass.png" width="20px"/>
