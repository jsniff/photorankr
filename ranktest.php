...
for($iii=1; $iii <= 16; $iii++) {
    ...
    #galleryRank<?php echo $id; ?>:hover {
            box-shadow: inset 0 0 9px #444; 
    }
    </style>
...
jQuery(document).ready(function(){
     jQuery("#rankButton<?php echo $id; ?>").live("click", function(event) {
         jQuery("#galleryRank<?php echo $id; ?>").toggle();
         jQuery("#tooltip").hide();
    });
});
</script>
    ...
    <div id="outer">
        ...
        <div id="galleryRank',$id,'">
            <div style="width:7px;float:left;padding:10px;border-right:1px solid #fff;"> 1 </div>
            <div style="width:7px;float:left;padding:10px;border-right:1px solid #fff;"> 2 </div>
            <div style="width:7px;float:left;padding:10px;border-right:1px solid #fff;"> 3 </div>
            <div style="width:7px;float:left;padding:10px;border-right:1px solid #fff;"> 4 </div>
            <div style="width:7px;float:left;padding:10px;border-right:1px solid #fff;"> 5 </div>
            <div style="width:7px;float:left;padding:10px;border-right:1px solid #fff;"> 6 </div>
            <div style="width:7px;float:left;padding:10px;border-right:1px solid #fff;"> 7 </div>
            <div style="width:7px;float:left;padding:10px;border-right:1px solid #fff;"> 8 </div>
            <div style="width:7px;float:left;padding:10px;border-right:1px solid #fff;"> 9 </div>
            <div style="width:7px;float:left;padding:10px;"><div style="margin-left:-4px;">10</div> </div>
        </div>
    ...
    if($email) {
        ...
        echo'
            ...
            <div class="statoverlay" style="z-index:1;background-color:white;position:relative;top:0px;width:280px;height:30px;">
                <div style="float:left;line-spacing:1.48;padding:5px;color:#4A4A4A;">
                    
                        <div id="rankButton',$id,'" style="cursor:pointer;float:left;height:37px;border-right:1px solid #aaa;margin-top:-5px;padding-top:6px;font-size:15px;font-weight:500;"><img style="width:18px;margin-top:-3px;padding:3px;" src="graphics/rank.png" /> ',$score,'&nbsp; </div>&nbsp;&nbsp;
                        <div style="float:left;padding-left:5px;padding-top:10px;font-weight:300;font-size:15px;">',$caption,'</span>
                    </div>
                </div>
            </div>';         	
	...
	$(window).scroll(function(){
		if($(window).scrollTop() > $(document).height() - $(window).height()-100) {
			if(last != $(".fPic:last").attr("id")) {
				...
				$.ajax({
					url: "loadMoreNewPicsTest.php?lastPicture=" + $(".fPic:last").attr("id")+"&c=',$cat,'"+"&email=',$email,'",
