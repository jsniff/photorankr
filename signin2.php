...
//start session
    ...
    //need to change this like twitter so that if user id or password is taken
    if($_GET['action'] == "signuponboard") { //if they tried to sign up from index3.php
...
if ($_GET['action'] == "login") { // if login form has been submitted
  ...
  if($_POST['password'] == $pass)
  {
    ...
    mysql_query("UPDATE userinfo2 SET password = md5('$pass') WHERE emailaddress = '".$_POST['emailaddress']."'");
    $isGood = 1;
  }
  else
  { 
  $bcrypt = new Bcrypt(15);
  $isGood = $bcrypt->verify($_POST['password'], $info['password']);   
  }
	if($isGood==1){
...
<div class="grid_12" style="padding-left:0px;margin-top:65px">

<!--REGISTER AS A NEW USER INTERFACE-->


<span style="font-size:22px;line-height:26px;">You're almost ready to join the fastest<br /> growing photography network around.</span>

<div style="font-family:lucida grande, gill sans;margin-top:15px;">
<div id="register">
<form method="post" action="myprofile.php?action=signup">
<br />
<label style="float:left;text-align:right;width:170px;padding-right:10px;font-size:16px;">First name:</label><input type="text" value = "<?php echo $firstname; ?>" style="width:180px;height:25px;" name="firstname"/><br/>
<br/>
<label style="float:left;text-align:right;width:170px;padding-right:10px;font-size:16px;">Last name:</label><input type="text" value = "<?php echo $lastname; ?>" style="width:180px;height:25px;" name="lastname"/><br/>
<br/>
<label style="float:left;text-align:right;width:170px;padding-right:10px;font-size:16px;">Email address:</label><input type="text" value = "<?php echo $newemail; ?>" style="width:180px;height:25px;" name="emailaddress"/><br/>
<br/>
<label style="float:left;text-align:right;width:170px;padding-right:10px;font-size:16px;">Password:</label><input type="password" value = "<?php echo $password; ?>" style="width:180px;height:25px;" name="password"/><br/>
<br/>
<label style="float:left;text-align:right;width:170px;padding-right:10px;font-size:16px;">Confirm password:</label><input type="password" style="width:180px;height:25px;" name="confirmpassword"/><br/>
<br/>
...
<!--Terms of Use Begin-->
<div style="border:2px solid rgb(204, 204, 204);border-radius:3px;background:white;height:80px;width:420px;overflow-x:hidden;overflow-y:scroll">
<p style="font-size:11px;line-height:1.3;font-family:"Helvetica Neue", Helvetica, sans-serif;">

PLEASE READ THESE TERMS AND CONDITIONS OF USE (&#34;TERMS OF USE&#34;) CAREFULLY.  BY ACCESSING OR USING THIS WEB SITE, YOU AGREE TO BE BOUND BY THESE TERMS OF USE.
<br />
<br />
...
<input type="checkbox" name="terms" value="terms" />&nbsp;&nbsp;<span style="font-size:13px;">By checking here and clicking the button, you agree to the above terms.</br></span>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="terms.php" style="font-size:13px;">Printable version of Terms.</a>&nbsp;&nbsp;<a href="privacy.php" style="font-size:13px;">Privacy Policy.</a></br></br>
...
//Cross Check If email already exists in database


$checkemailaddress = mysql_query("SELECT * FROM userinfo WHERE emailaddress = '".$newemail."'")or die(mysql_error());
$checkallemailaddresses = mysql_num_rows($checkemailaddress);
//echo $checkallemailaddresses;
if ($checkallemailaddresses != 0) {
die('That user Already Exists in Our database. Please fill out form here');
}
...
<div style="margin-left:470px; margin-top:-525px;">
<a href="trending.php"><img src="graphics/frontgraphic.png" width="540" height="540" /></a>
<br />
<br />
</div>
