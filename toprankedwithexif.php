...
<!--NAVIGATION BAR-->
<div class="navbar" style="padding-top:0px;z-index:10;font-size:16px;width:100%;">
...
echo'
     ...
     ?>
					...
					<li ><a style="color:#fff;margin-top:2px;" style="color:rgb(56,85,103);margin-right:20px;" href="newest.php">Newest</a></li>
					<li style="background-color:#587fa2;"><a style="color:#fff;margin-top:2px;" style="color:rgb(56,85,103);margin-right:20px;" href="topranked.php">Top Ranked</a></li>
...
<a class="accordion-toggle" href="#collapseOne" data-parent="#accordion2" data-toggle="collapse">Photography </a>
</div>
<div id="collapseOne" class="accordion-body collapse">
<div class="accordion-inner"> 
<a href="topranked.php">All Time</a>
<br />
<a href="topranked.php?t=m">Month</a>
<br />
<a href="topranked.php?t=w">Week</a>
<br />
</div>
</div>
</div>
...
<div class="accordion-group">
<div class="accordion-heading">
<a class="accordion-toggle" href="topranked.php?v=prs">Photographers </a>
</div>
...
list($width, $height) = getimagesize($image);
    ...
    $widthls = $width / 3.5;
        ...
        echo'
		<div class="item" style="width:240px;height:330px;overflow:hidden;background-color:white;">
			<a href="fullsize.php?image=',$image,'&v=r"><img onmousedown="return false" oncontextmenu="return false;" style="min-height:240px;max-height:240px;min-width:240px;" src="http://www.photorankr.com/',$image,'" height="',$heightls,'px" width="',$widthls,'px" /></a><br /><span style="font-size:21px">&nbsp;#',$iii,'.</span><div style="margin-top:0px;font-size:15px;text-align:center;">"',$caption,'"<br />By: ',$fullname,'</div></div>'; 
