    ...
    elseif($view == 'big') {
        ...
        echo'<div class="bigBox">
                ...
                <div class="grid_1 arrowleft">
                    <a id="ajaxBack" href="javascript:ajaxBack(',$imageid,')"><img src="graphics/newarrowleft.png" /></a>
                </div>
                ...
                <div class="grid_1 arrowright">
                    <a id="ajaxNext" href="javascript:ajaxNext(',$imageid,')"><img src="graphics/newarrowright.png" /></a>
                </div>
