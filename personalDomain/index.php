...
<div class="topBar">
    ...
    <ul>
        ...
        <a href="cart.php"><li> Cart (<?php echo $incartresults; ?>)</li></a>
    </ul>
</div>
...
<?php 
    ...
    <!--AJAX CODE HERE-->
   <div class="grid_6 push_9" style="padding-top:25px;padding-bottom:25px;">
    ...
    elseif($view == 'big') {
        ...
        echo'<div style="width:1200px;">
            ...
            <div class="bigBox">
                ...
                <div id="nextimgid" style="width:800px;padding:0px;float:left;overflow:hidden;height:530px;">
                <table id="wrapper">
                    <tr>
                    <td>
           ...
           <div class="rightInfo">
                ...
                <p id="price"><img style="width:15px;" src="https://photorankr.com/graphics/tag.png" /> ',$price,' <a id="ajaxCart" href="javascript:ajaxCart(',$imageid,')"> Add to Cart </a> </p>
                <p id="about">',$about,' </p>
           </div>
...
<!---Powered by PhotoRankr Stamp
<div style="float:center;font-size:13px;font-weight:500;position:relative;top:20px;color:rgb(245,245,245);left:0px;bottom:20px;">
    <a style="color:white;" href="https://photorankr.com">Powered by PhotoRankr<a/> <img src="https://photorankr.com/graphics/aperture_dark.png" height="34" />
    <br /><br />
</div>--->
	...
	ajaxRequest.onreadystatechange = function(){
		if(ajaxRequest.readyState == 4){
           ...
           //image source
            ...
            price.innerHTML = json.price + '<a id="ajaxCart" href="javascript:ajaxCart('+json.nextimgid+')"> Add to Cart </a>';
...
//AJAX CART 
function ajaxCart(image){
    var image = image;
    ajaxRequest = createRequestObject();
    // Create a function that will receive data sent from the server
	ajaxRequest.onreadystatechange = function(){
		if(ajaxRequest.readyState == 4  && ajaxRequest.status == 200){
			var ajaxDisplay = document.getElementById('ajaxCart');
            ajaxDisplay.innerHTML = ajaxRequest.responseText;
		}
	}
	var age = "<?php echo $emailaddress; ?>";
	var queryString = "?age=" + age + "&image=" + image;
	ajaxRequest.open("GET", "ajaxCart.php" + queryString, true);
	ajaxRequest.send(null); 
}
