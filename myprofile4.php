...
<a style="text-decoration:none;color:black;" href="myprofile.php"><div class="clicked" style="width:180px;height:60px;border-right:1px solid #ccc;border-left:1px solid #ccc;float:left;<?php if($view == '') {echo'background-color:#bbb;color:white;';} ?>"><div style="font-size:25px;font-weight:100;margin-top:10px;text-align:center;">Portfolio</div></div></a>

<a style="text-decoration:none;color:black;" href="myprofile.php?view=store"><div class="clicked" style="width:180px;height:60px;border-right:1px solid #ccc;float:left;<?php if($view == 'store') {echo'background-color:#bbb;color:white;';} ?>"><div style="font-size:25px;font-weight:100;margin-top:10px;text-align:center;">My Store</div></div></a>

<a style="text-decoration:none;color:black;" href="myprofile.php?view=blog"><div class="clicked" style="width:180px;height:60px;border-right:1px solid #ccc;float:left;<?php if($view == 'blog') {echo'background-color:#bbb;color:white;';} ?>"><div style="font-size:25px;font-weight:100;margin-top:10px;text-align:center;">Blog</div></div></a>
...
<?php
    ...
    if($view == '') {
        ...
        for($iii=0; $iii < $numresults; $iii++) {
                ...
                <div class="fPic" id="',$id,'" style="width:245px;height:245px;overflow:hidden;float:left;margin-left:10px;margin-top:30px;"><a href="http://photorankr.com/fullsizeme.php?image=', $image[$iii], '">
...
$numphotosgrabbed = mysql_num_rows($grabphotosrun);
    ...
    echo'<div style="width:245px;height:245px;overflow:hidden;float:left;margin-left:10px;margin-top:30px;"><a href="myprofile.php?view=exhibits&set=',$set_id[$iii],'">
...
var last = 0;
    ...
    //ADD TO CART IN DB
        ...
        <div style="text-align:center;font-size:18px;">Login Below or <a href="signin.php">Register to Buy:</a></div><br />
