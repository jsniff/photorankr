		...
		$cartmatch=preg_match($regex2,$search_string2);
            ...
            ?>
                ...
                <script type="text/javascript">
                    ...
                    <?php
                    echo'<a class="btn btn-success" style="margin-left:10px;width:80px;float:left;" href="download2.php?imageid=',$imageid,'&size=large&action=added">Add to Cart</a>';
                    ?>
