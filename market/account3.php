...
<div style="position:relative;left:0px;top:-25px;margin-left:20px;text-align:center;">
   <div style="float:left;"><p>Downloads:&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;</p></div>
   <div style="float:left;"><p>Photographers:</p></div>
</div>

<div style="position:relative;top:-35px;margin-left:52px;text-align:center;font-size:20px;">
   <div style="float:left;"><p>&nbsp;&nbsp; <?php echo $numdownloads; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p></div>
...
<a style="text-decoration:none;color:black;font-weight:100;" href="account3.php?view=saved"><div style="width:250px;margin-top:-10px;padding-bottom:4px;">
...
<hr>
<a style="text-decoration:none;color:black;font-weight:100;" href="account3.php?view=downloads"><div style="width:250px;margin-top:-10px;padding-bottom:4px;">
...
<hr>
<a style="text-decoration:none;color:black;font-weight:100;" href="account3.php?view=photogs"><div style="width:250px;margin-top:-10px;padding-bottom:4px;">
...
<hr>
<a style="text-decoration:none;color:black;font-weight:100;" href="account3.php?view=account"><div style="width:250px;margin-top:-10px;padding-bottom:4px;">
...
<a style="text-decoration:none;color:black;" href="account3.php"><div class="clicked" style="width:180px;height:60px;border-right:1px solid #ccc;float:left;<?php if($view == '') {echo'background-color:#bbb;color:white;';} ?>"><div style="font-size:25px;font-weight:100;margin-top:10px;text-align:center;">My Cart</div></div></a>

<a style="text-decoration:none;color:black;" href="account3.php?view=mycampaigns"><div class="clicked" style="width:180px;height:60px;border-right:1px solid #ccc;border-left:1px solid #ccc;float:left;<?php if($view == 'mycampaigns') {echo'background-color:#bbb;color:white;';} ?>"><div style="font-size:25px;font-weight:100;margin-top:10px;text-align:center;">My Campaigns</div></div></a>

<a style="text-decoration:none;color:black;" href="account3.php?view=prefs"><div class="clicked" style="width:180px;height:60px;border-right:1px solid #ccc;float:left;<?php if($view == 'prefs') {echo'background-color:#bbb;color:white;';} ?>"><div style="font-size:25px;font-weight:100;margin-top:10px;text-align:center;">My Preferences</div></div></a>
...
elseif($view == 'saved') {
            ...
            $option = htmlentities($_GET['option']);
             ...
             echo'<br /><br /><br /><br /><div style="width:760px;text-align:center;font-size:14px;font-weight:200;"><div style="margin-left:20px;"><a class="green" style="text-decoration:none;color:#000;';if($option == '') {echo'color:#6aae45;';} else {echo'color:#333;';} echo'" href="account3.php?view=saved">Market Photos</a> | <a class="green" style="text-decoration:none;color:#000;';if($option == 'campaigns') {echo'color:#6aae45;';} else {echo'color:#333;';} echo'" href="account3.php?view=saved&option=campaigns">Campaign Photos</a></div></div>';
    ...
    if($option == '') {
                ...
                <div class="statoverlay" style="z-index:1;left:0px;top:180px;position:relative;background-color:black;width:245px;height:75px;"><p style="line-spacing:1.48;padding:5px;color:white;"><span style="font-size:16px;font-weight:100;">',$caption,'</span><br><span style="font-size:20px;font-weight:100;">$',$price,'</span></p><a name="removed" href="account3.php?view=saved&pd=',$photoid[$iii],'&action=remove#return"><button class="btn btn-primary" style="z-index:12;position:relative;top:-52px;float:right;margin-right:5px;">Remove Photo</button></a></div>
    ...
    elseif($option == 'campaigns') {
            ...
            echo'
                ...
                <div class="statoverlay" style="z-index:1;left:0px;top:180px;position:relative;background-color:black;width:245px;height:75px;"><p style="line-spacing:1.48;padding:5px;color:white;"><span style="font-size:16px;font-weight:100;">',$caption,'</span><br><span style="font-size:20px;font-weight:100;">Score: ',$average,'</span></p><a name="removed" href="account3.php?view=saved&option=campaigns&pd=',$photoid,'&action=remove#return"><button class="btn btn-primary" style="z-index:12;position:relative;top:-52px;float:right;margin-right:5px;">Remove Photo</button></a></div>
...
elseif($view == 'downloads') {
    ...
    $option = htmlentities($_GET['option']);
     ...
     echo'<br /><br /><br /><br /><div style="width:760px;text-align:center;font-size:14px;font-weight:200;"><div style="margin-left:20px;"><a class="green" style="text-decoration:none;color:#000;';if($option == '') {echo'color:#6aae45;';} else {echo'color:#333;';} echo'" href="account3.php?view=mycampaigns">All</a> | <a class="green" style="text-decoration:none;color:#000;';if($option == 'current') {echo'color:#6aae45;';} else {echo'color:#333;';} echo'" href="account3.php?view=mycampaigns&option=current">Current</a> | <a class="green" style="text-decoration:none;color:#000;';if($option == 'previous') {echo'color:#6aae45;';} else {echo'color:#333;';} echo'" href="account3.php?view=mycampaigns&option=previous">Previous</a> | <a class="green" style="text-decoration:none;color:#000;';if($option == 'create') {echo'color:#6aae45;';} else {echo'color:#333;';} echo'" href="account3.php?view=mycampaigns&option=create">Create Campaign</a></div></div>';
