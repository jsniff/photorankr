...
<?php
 //MAKE SURE CORRECT BUTTON SHOWS
        ...
        if($fwmatch > 0) {
        echo'<a style="float:left;width:70px;margin-top:40px;margin-left:10px;font-size:14px;font-weight:150;" class="btn btn-primary" href="viewprofile.php?u=',$userid,'&action=unfollow">Unfollow</a>';
        }
        else {
        echo'<div style="float:left;width:70px;margin-top:40px;margin-left:10px;font-size:14px;font-weight:150;" data-toggle="modal" data-backdrop="static" href="#followmodal" class="btn btn-success">Follow</div>';
        }
?>
...
<span class="green" style="text-align:center;font-size:24px;padding:15px;<?php if($view == 'about') {echo'color:#6aae45;';} ?>">Information&nbsp;&nbsp;<img style="float:right;padding-top:5px;padding-right:20px;" src="graphics/info.png" height="30" width="30"></span>
</div></a>
...
<a style="text-decoration:none;color:black;" href="viewprofile.php?u=<?php echo $userid; ?>&view=exhibits"><div class="clicked" style="width:180px;height:60px;border-right:1px solid #ccc;float:left;<?php if($view == 'exhibits') {echo'background-color:#bbb;color:white;';} ?>"><div style="font-size:25px;font-weight:100;margin-top:10px;text-align:center;">Exhibits</div></div></a>

<a style="text-decoration:none;color:black;" href="viewprofile.php?u=<?php echo $userid; ?>&view=deal"><div class="clicked" style="width:180px;height:60px;border-right:1px solid #ccc;float:left;<?php if($view == 'deal') {echo'background-color:#bbb;color:white;';} ?>"><div style="font-size:25px;font-weight:100;margin-top:10px;text-align:center;">Best Deal</div></div></a>
...
<input class="search" style="position:relative;margin-left:15px;margin-top:2px;font-family:helvetica;font-size:14px;font-weight:100;color:black;padding:5px;" name="searchterm" placeholder="Search Portfolio&nbsp;.&nbsp;.&nbsp;.&nbsp;" type="text">
</form></div></div>
...
<?php
    ...
    if($view == '') {
        ...
        if($sort == '') {        
        $query = mysql_query("SELECT * FROM photos WHERE emailaddress = '$useremail' AND price != ('Not For Sale') ORDER BY id DESC LIMIT 0,21");
...
<div style="margin-top:15px;">
    <div class="control-group" style="float:left;">
          ...
          <div class="controls">
           <form action="viewprofile.php?u=<?php echo $userid; ?>&sort=price" method="post">
    ...
    <div class="control-group" style="float:left;">
          ...
          <label class="control-label"></label>
          <div class="controls">
           <form action="viewprofile.php?u=<?php echo $userid; ?>&sort=rank" method="post">
...
<div class="control-group" style="float:left;">
          ...
          <label class="control-label"></label>
          <div class="controls">
           <form action="viewprofile.php?u=<?php echo $userid; ?>&sort=category" method="post">
...
<option value="Advertising">Advertising</option>
    ...
    <div class="control-group" style="float:left;">
          ...
          <label class="control-label"></label>
          <div class="controls">
           <form action="viewprofile.php?u=<?php echo $userid; ?>&sort=style" method="post">
    ...
    <?php
        ...
        echo'<div id="thepics">';
        echo'<div id="container" class="grid_18" style="width:770px;margin-top:-20px;padding-left:0px;">';
        ...
        for($iii=0; $iii < $numresults; $iii++) {
                ...
                <div class="statoverlay" style="z-index:1;left:0px;top:180px;position:relative;background-color:black;width:245px;height:75px;"><p style="line-spacing:1.48;padding:5px;color:white;"><span style="font-size:16px;font-weight:100;">',$caption,'</span><br><span style="font-size:20px;font-weight:100;">$',$price,'</span></p></div>
...
elseif($view == 'exhibits') {
        ...
        echo'<div class="grid_18" style="width:770px;margin-top:0px;padding-left:10px;">';
...
echo'<div class="grid_18" style="width:770px;margin-top:0px;margin-left:-20px;padding:35px;">

<div class="well grid_14" style="width:735px;font-size:16px;line-height:25px;margin-top:0px;"><u>Exhibit:</u> "',$settitle,'"<br />';
if($about) { echo'<br /><u>About this exhibit:</u> ',$aboutset,'<br /><br />'; }
echo'</div>';
...
for($iii=0; $iii < $numphotosgrabbed; $iii++) {
    ...
    $newsource = str_replace("userphotos/","http://photorankr.com/userphotos/medthumbs/", $insetsource[$iii]);
    ...
    $id = mysql_result($grabphotosrun, $iii, "id");
    ...
    echo'<div style="width:245px;height:245px;overflow:hidden;float:left;margin-left:10px;margin-top:30px;"><a href="fullsize2.php?imageid=',$id,'">
...
elseif($view == 'deal') {
        ...
        $query = mysql_query("SELECT * FROM photos WHERE emailaddress = '$useremail' AND price < '$deal' AND time > $twoweeksago AND price != ('Not For Sale') ORDER BY id DESC LIMIT 0,21");
        $numresults = mysql_num_rows($query);
