...
<img class="roundedall" src="<?php echo $profilepic; ?>" height="115" width="115"/>
</div>
    ...
    elseif($view == 'store') {
        ...
        if($option == '') {        
            ...
            if(htmlentities($_GET['updateimage'])) {
                ...
                echo $newprice; echo $newlicenses[1]; echo $newlicenses[0];
        ...
        <td>
            ...
            <select id="price" name="price" style="width:120px;float:left;margin-left:-70px;" onchange="showOtherPrice()">
        ...
        <tr>
        <td><div style="width:150px;"><input type="checkbox" name="license[]" value="multiseat" />&nbsp;&nbsp;Multi-Seat</div></td>
        <td>+ $30</td>
        </tr>
        
        <tr>
        <td><div style="width:150px;"><input type="checkbox" name="license[]" value="printruns" />&nbsp;&nbsp;Unlimited Reproduction</div></td>
        <td colspan="2">+ $40</td>
        </tr>
        
        <tr>
        <td><div style="width:150px;"><input type="checkbox" name="license[]" value="resale" />&nbsp;&nbsp;Allow Resale</div></td>
        <td colspan="2">+ $50</td>
        </tr>
        
        <tr>
        <td><div style="width:150px;"><input type="checkbox" name="license[]" value="electronic" />&nbsp;&nbsp;Allow Electronic Use</div></td>
        <td colspan="2">+ $60</td>
        </tr>
        ...
        <button class="btn btn-success" type="submit" style="width:210px;padding:7px;" href="#">Update Info</button>
        </form>
        </div>
...
<!--[if lt IE 9]><script src="http://html5shim.googlecode.com/svn/trunk/html5.js"></script><![endif]-->
    ...
    <form id="fileupload" action="batch/server/php/" method="POST" enctype="multipart/form-data">
        ...
        <div class="row fileupload-buttonbar" style="margin-left:150px;margin-top:35px;">
            <div class="span7">
...
{% for (var i=0, file; file=o.files[i]; i++) { %}
    <tr class="template-upload fade">
        ...
        <div>
        <div>    
	<td colspan="1" class="desc">Name: <input type="text" style="width:120px;" name='{%= "keyword_" + String(file.name).replace(/([.]+)/gi, '_')%}' /></td>
        </div>
        <div>
