...
session_start();
    ...
    $keywords = $tag1 . $tag2 . $tag3 . $tag4 . $singlestyletags . $singlecategorytags;
...
<?php
$smallwidth = number_format(($width/2.5),0);
$smallheight = number_format(($height/2.5),0);
$smallprice = number_format(($price / 2.5),0);
$medwidth = number_format(($width/1.3),0);
$medheight = number_format(($height/1.3),0);
