...
<a data-toggle="modal" data-backdrop="static" href="#fwmodal" class="btn btn-success" style="float:left;width:70px;margin-top:40px;margin-left:10px;font-size:14px;font-weight:150;">Follow</a>
</div>
...
<span class="green" style="text-align:center;font-size:24px;padding:15px;<?php if($view == 'favorites') {echo'color:#6aae45;';} ?>">Information&nbsp;&nbsp;<img style="float:right;padding-top:5px;padding-right:20px;" src="graphics/info.png" height="30" width="30"></span>
</div></a>
...
<a style="text-decoration:none;color:black;" href="viewprofile3.php?u=<?php echo $userid; ?>&view=exhibits"><div class="clicked" style="width:180px;height:60px;border-right:1px solid #ccc;float:left;<?php if($view == 'exhibits') {echo'background-color:#bbb;color:white;';} ?>"><div style="font-size:25px;font-weight:100;margin-top:10px;text-align:center;">Exhibits</div></div></a>

<a style="text-decoration:none;color:black;" href="viewprofile3.php?u=<?php echo $userid; ?>&view=deal"><div class="clicked" style="width:180px;height:60px;border-right:1px solid #ccc;float:left;<?php if($view == 'deal') {echo'background-color:#bbb;color:white;';} ?>"><div style="font-size:25px;font-weight:100;margin-top:10px;text-align:center;">Best Deal</div></div></a>
...
<div style="margin-top:15px;">
    <div class="control-group" style="float:left;">
          ...
          <div class="controls">
           <form action="viewprofile3.php?u=<?php echo $userid; ?>&sort=price" method="post">
    ...
    <div class="control-group" style="float:left;">
          ...
          <label class="control-label"></label>
          <div class="controls">
           <form action="viewprofile3.php?u=<?php echo $userid; ?>&sort=rank" method="post">
...
<div class="control-group" style="float:left;">
          ...
          <label class="control-label"></label>
          <div class="controls">
           <form action="viewprofile3.php?u=<?php echo $userid; ?>&sort=category" method="post">
...
<option value="Advertising">Advertising</option>
    ...
    <div class="control-group" style="float:left;">
          ...
          <label class="control-label"></label>
          <div class="controls">
           <form action="viewprofile3.php?u=<?php echo $userid; ?>&sort=style" method="post">
