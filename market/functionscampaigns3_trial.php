	...
	<div class="navbar-inner" style="background: #6BBE44;">
		<div class="container" style="width:700px;">
                ...
                <li> <img style="position:relative;left:-10px;margin-top:8px;" src="graphics/logo.png" height="22px" /></li>';
                    ...
                    if($view == '') {
                    echo'
                    <li><a style="color:#fff;margin-top:2px;padding-bottom:9px;" style="color:rgb(56,85,103);margin-right:20px;" href="viewprofile_trial.php?u=',$userid,'">Newest</a></li>
                    <li><a style="color:#fff;margin-top:2px;padding-bottom:9px;margin-right:20px;" href="viewprofile_trial.php?u=',$userid,'&od=topranked">Top Ranked</a></li>
                    <li><a style="color:#fff;margin-top:2px;padding-bottom:9px;margin-right:20px;" href="viewprofile_trial.php?u=',$userid,'&od=pop">Most Popular</a></li>';
                    }
