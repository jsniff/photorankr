...
require "functionscampaigns2.php"; 
...
if($view == "") {
	...
	for($iii=0; $iii < mysql_num_rows($allcampaignsresult); $iii++) {
		...
		echo '
		<div class="phototitle fPic" id="',$id[$iii],'" style="width:280px;height:280px;overflow:hidden; margin-right: 30px;">
...
//otherwise they are looking at the past campaigns
	...
	for($iii=0; $iii < mysql_num_rows($allcampaignsresult); $iii++) {
		...
		echo '
		<div class="phototitle fPic" id="',$id[$iii],'" style="width:280px;height:280px;overflow:hidden;">
			<a href="campaignphotos.php?id=',$id[$iii],'">
...
<a class="accordion-toggle" style="color:#21608E;" href="viewcampaigns.php">Current</a>
</div>
...
<div class="accordion-group">
<div class="accordion-heading">
<a class="accordion-toggle" style="color:#21608E;" href="viewcampaigns.php?view=previous">Previous</a>
</div>
