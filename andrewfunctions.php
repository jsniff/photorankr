...
<?php
    ...
    if($_SESSION['loggedin'] == 1) { 
        echo'<li id="shadow" '; if(strpos($uri,'newsfeed.php')) {echo' id="inset"';} echo'><a href="newsfeed.php"><img src="graphics/news_b.png"/><p> News </p></a></li>';
    }
    
    echo'
        <li id="shadow" '; if(strpos($uri,'galleries.php') || strpos($uri,'newest.php') || strpos($uri,'trending.php') || strpos($uri,'topranked.php') || strpos($uri,'discover.php') || strpos($uri,'fullsize.php') || strpos($uri,'fullsizeview.php')) {echo' id="inset"';} echo'><a href="galleries.php"><img src="graphics/galleries_b.png"/><p> Galleries </p><div class="arrow-right"></div></li></a>
        
		<li id="shadow" '; if(strpos($uri,'groups.php')) {echo' id="inset"';} echo'><a href="groups.php"><img src="graphics/groups_b.png"/><p> Groups </p></a></li>
        
		<li id="shadow" '; if(strpos($uri,'market.php') || strpos($uri,'cart.php')) {echo' id="inset"';} echo'><a href="market.php"><img src="graphics/market_b.png"/><p> Market </p></a></li>
        
		<li id="shadow" '; if(strpos($uri,'blog.php')) {echo' id="inset"';} echo'><a href="blog.php"><img src="graphics/blog_b.png"/><p> Blog </p></a></li>
	</ul>
</div>
...
<div class="CNav">
	<ul>';
        ...
        if($_SESSION['loggedin'] == 1) {
            ...
            echo'<li style="width:140px;height:19px;float:right;margin-top:-5px;">
                    <img id="hideshow" style="height:30px;width:30px;" src="https://photorankr.com/',$sessionprofilepic,'" />
                    <a style="text-decoration:none;color:#fff;" href="profile.php"><span id="notifNum" style="color:#fff;text-align:center;font-size:13px;font-weight:500;padding-bottom:5px;">',$sessionfull,'</span>
                    </a>
                 </li>';
        }
