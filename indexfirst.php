...
<hgroup>
     ...
     <?php
            ...
            elseif(htmlentities($_GET['action']) == 'activated') {
                        ...
                        echo'<div class="grid_6 pull_4" id="bar_container" style="color:green;font-size:18px;font-weight:bold;text-align:center;margin-bottom:8px;">You may now login to your account</div>';
