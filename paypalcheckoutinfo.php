...
function PPHttpPost($methodName_, $nvpStr_) {
	...
	$API_UserName = urlencode('photorankr_api1.photorankr.com');
	$API_Password = urlencode('BEQVEQ8T2TC7C3BA');
	$API_Signature = urlencode('AoWwKxZQ1QsvCE1iFLWS13bNsFGxAxVo3QGpTwBMbHfLF9ukeWlHwL');
