...
<div class="grid_18 roundedright pull_1" style="background-color:#eeeff3;height:60px;margin-top:80px;width:800px;margin-left:-43px;">
...
<?php
        ...
        for($iii=0; $iii < $numresults; $iii++) {
                ...
                <div class="fPic" id="',$id,'" style="width:245px;height:230px;overflow:hidden;float:left;margin-left:10px;margin-top:30px;"><a href="http://photorankr.com/fullsizemarket.php?imageid=',$id,'">
