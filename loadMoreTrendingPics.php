...
if($_GET['lastPicture']) {
	...
	//DISPLAY 20 NEWEST OF ALL PHOTOS
 	echo'<div id="container" style="width:1140px;position:relative;left:-120px;top:50px;">';
	...
	for($iii=1; $iii <= 8; $iii++) {
		...
		$imgratio = $height / $width;
    		...
    		echo '<div class="phototitle fPic" id="',$id,'" style="width:240px;height:240px;overflow:hidden;"><a href="http://www.photorankr.com/fullsize.php?image=',$image,'&v=t">
