...
$sType = 'scale';
    ...
    $img = @imagecreatefromjpeg($downloadsource)
...
header("Content-type: image/jpeg");
 ...
 //            </form>
 //            </div>
 //                <img onmousedown="return false" oncontextmenu="return false;" style="position:relative;top:-90px;min-height:265px;min-width:245px;" src="',$img,'" height="',$widthnew,'px" width="',$heigthnew,'px" /></a></div>';
